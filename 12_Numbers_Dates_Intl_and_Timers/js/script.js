...
const account1 = {
  ...
  movementsDates: [
    ...
    '2022-08-02T17:01:17.194Z',
    '2022-08-06T23:36:17.929Z',
...
console.log(Math.max(5, 16, 32, 11, 2));
console.log(Math.max(5, 16, '32', 11, 2));
console.log(Math.max(5, 16, '32px', 11, 2));

console.log(Math.min(5, 16, 32, 11, 2));
...
//////////////////////////////////////////
//// Timers: SETTIMEOUT 1 SETINTERVAL ////
